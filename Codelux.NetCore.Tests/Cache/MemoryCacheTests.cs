...
using Codelux.NetCore.Cache;

namespace Codelux.NetCore.Tests.Cache
{
    [TestFixture]
    public class MemoryCacheTests
    {
        ...
        {
            TestModel model = new TestModel() { Id = Guid.NewGuid() };
            TestModel modelReplacement = new TestModel() { Id = Guid.NewGuid() };
        ...
        {
            TestModel model1 = new TestModel() { Id = Guid.NewGuid() };
            TestModel model2 = new TestModel() { Id = Guid.NewGuid() };
            TestModel model3 = new TestModel() { Id = Guid.NewGuid() };
            TestModel model4 = new TestModel() { Id = Guid.NewGuid() };
